...
class AmountCalculatorTest extends TestCase
{
    ...
    {
        $allowedAmountRange = new AmountRange(new CounterForAmount(1), new CounterForAmount(1));
    ...
    {
        $allowedAmountRange = new AmountRange(new CounterForAmount(2), new CounterForAmount(3));
        $amountCalculator = new AmountCalculator();
        $amountMap = [
            0 => new CounterForAmount(0, 2),
            1 => new CounterForAmount(1, 3),
    ...
    {
        $allowedAmountRange = new AmountRange(new CounterForAmount(2, 2), new CounterForAmount(3));
        $amountCalculator = new AmountCalculator();
        $amountMap = [
            0 => new CounterForAmount(0, 2),
            1 => new CounterForAmount(1, 3),
    ...
    {
        $allowedAmountRange = new AmountRange(new CounterForAmount(2, 8), new CounterForAmount(3));
        $amountCalculator = new AmountCalculator();
        $amountMap = [
            0 => new CounterForAmount(0, 2),
            1 => new CounterForAmount(1, 3),
    ...
    public function testGreaterThanMaxItOne(): void
    {
        ...
        self::assertSame(3, $amountCalculator->calculateGreaterThan($allowedAmountRange->min, $amounts));
    }
    ...
    {
        $allowedAmountRange = new AmountRange(new CounterForAmount(1), new CounterForAmount(1, 5));
        $amountCalculator = new AmountCalculator();
        $amountMap = [
            0 => new CounterForAmount(0, 2),
            1 => new CounterForAmount(1, 3),
