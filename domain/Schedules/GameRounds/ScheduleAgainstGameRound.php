...
/**
 * @template-extends ListNode<ScheduleAgainstGameRound>
 */
final class ScheduleAgainstGameRound extends ListNode
{
    ...
    public function __construct(ScheduleAgainstGameRound|null $previous = null)
    {
        parent::__construct($previous);
    }

    public function createNext(): ScheduleAgainstGameRound
    {
        $this->next = new ScheduleAgainstGameRound($this);
        return $this->next;
    }
    ...
    public function add(HomeAway $homeAway): void
    {
        ...
        foreach ($homeAway->getPlaceNrs() as $placeNr) {
            $this->placeNrMap[$placeNr] = $placeNr;
        }
    }
