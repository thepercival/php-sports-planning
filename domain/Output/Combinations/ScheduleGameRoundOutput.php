...
final class ScheduleGameRoundOutput extends OutputAbstract
{
...
//        }
     ...
     * @param ScheduleAgainstGameRound|null $gameRound
     * @param string|null $header
     * @return void
     */
    public function outputHomeAways(array $homeAways, ScheduleAgainstGameRound|null $gameRound = null, string|null $header = null): void
    {
        if ($header !== null) {
